...
// includining the SigFox module 
#include <SigFox.h>

#include <ArduinoLowPower.h>// including the The Low power 
void setup() {
Serial.begin(9600);
while (!Serial) {};
...
Serial.println("Response from server:");while (SigFox.available()) {
Serial.print("0x");
